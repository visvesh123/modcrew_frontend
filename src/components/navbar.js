            ...
            <div className="main-div">
              <div className="row upper-navbar">
                ...
                <div className="col social-icons">
                  ...
                  <button>
                    <IoIosCall size={20} className="white-color" />
                  </button>
                  {loggedInToken ? (
                    <button
                      className="login-btn "
              ...
              <div className="navbar-search ">
                ...
                <form className="col-md-4 col-xs-8">
                  <input
                    type="search"
              ...
              <div className="button-tray">
                <button className="navbar-buttons col-xs-2">
                  <AiOutlineHeart size={25} className="white-color" />
                </button>
                <button
                  className="navbar-buttons col-xs-2"
                  onClick={() => {
                    goToCart();
                  }}
                >
