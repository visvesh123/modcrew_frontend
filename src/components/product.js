...
function Product(props) {
  ...
  return (
    <div className="card product-card col-3">
      <div
        onMouseOver={() => mouseOverEffect(props.id)}
        onMouseOut={() => mouseOutEffect(props.id)}
      >
        <div
          className="hover-div-btns d-none"
          id={`hover-${props.id}`}
          onMouseOver={() => {
            handleEyeColourOver(props.id);
          }}
          onMouseOut={() => {
            handleEyeColourOut(props.id);
          }}
        >
          <Link to={`/productPage/${props.productId}`}>
            <button id="eye-btn" className="landing-page-button">
              <img className="hover-btns view-btn" src={view} />
            </button>
          </Link>
          <Link to={"/cart"}>
        ...
        <img
          ...
          onMouseOver={() => {
            transparentOverEffect(props.id);
          }}
          onMouseOut={() => {
            transparentOutEffect(props.id);
          }}
      ...
      <div className="card-body product-body row">
        <div className="col-10">
          <div className="star-icon">
            {/* <span > */}
            <i className="fas fa-star"></i> {props.avgRating}
        ...
        <div className="col-2">
          <button className="landing-page-button like-btn">
            {" "}
